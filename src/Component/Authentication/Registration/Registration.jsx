...
const Registration = () => {
  ...
  return (
    <div className="w11/12 mx-auto text-center">
      ...
      <div className="card bg-base-100 shadow-2xl w-[400px] shrink-0 py-7 ">
        {" "}
         <h1 className="text-center font-bold text-2xl ">Register Yourself</h1>
        <form
          className="text-center  w-full max-w-sm   relative mx-auto"
          ...
          <div className="card-body">
            <fieldset className="fieldset ">
              ...
              <span
                ...
                className="absolute  top-[275px] right-12 z-50"
              >
                {show ? "Hide" : "Show"}
              </span>
              ...
              <div className="text-[14px]">Alreay Have An Account <Link to='/login'><span className="text-blue-600">LogIn</span></Link> </div>
